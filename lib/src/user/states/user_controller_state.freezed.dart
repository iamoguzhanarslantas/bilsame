...
class _$_UserControllerState implements _UserControllerState {
  const _$_UserControllerState({required this.name, required this.email});
  ...
  @override
  String toString() {
    return 'UserControllerState(name: $name, email: $email)';
  }
...
abstract class _UserControllerState implements UserControllerState {
  const factory _UserControllerState(
      ...
      required final String? email}) = _$_UserControllerState;
